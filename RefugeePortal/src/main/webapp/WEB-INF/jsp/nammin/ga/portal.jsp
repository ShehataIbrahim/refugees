...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Logáil isteach</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Tá an clárú iomlán</p>
        </div>
        ...
        <a href="javascript:alert('Faigh fiosruithe leighis ag Messenger le do thoil. Má tá tú agallamh cheana féin, athlódáil.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ar mhaith leat logáil isteach?")){
            return false;
        }else{
            form_logout.submit();
        }
