...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Kijelentkezés</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">A regisztráció befejeződött</p>
        </div>
        ...
        <a href="javascript:alert('Kérjen egészségügyi kérdéseket a Messenger-en. Ha már interjút készítettél, kérlek töltsd be újra.')" class="menu-btn">
        <% }else{ %>
