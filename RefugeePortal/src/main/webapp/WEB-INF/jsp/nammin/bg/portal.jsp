...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Изход</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Регистрацията е завършена</p>
        </div>
        ...
        <a href="javascript:alert('Моля, потърсете медицинска информация в Messenger. Ако вече сте били интервюирани, моля, презаредете.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Искате ли да излезете?")){
            return false;
        }else{
            form_logout.submit();
        }
