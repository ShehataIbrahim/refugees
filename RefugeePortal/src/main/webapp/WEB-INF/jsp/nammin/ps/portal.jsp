...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ننوتل</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">راجستر بشپړ دی</p>
        </div>
        ...
        <a href="javascript:alert('مهرباني وکړئ د رسول په اړه طبي تحقیقات ترلاسه کړئ. که تاسو دمخه مرکه کړې وي نو مهرباني وکړئ بیا رالوی کړئ.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("ته د ننوتلو لپاره غواړئ؟")){
            return false;
        }else{
            form_logout.submit();
        }
