...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Wyloguj się</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Rejestracja jest zakończona</p>
        </div>
        ...
        <a href="javascript:alert('Proszę uzyskać odpowiedzi na pytania lekarskie w programie Messenger. Jeśli przeprowadzono już wywiad, przeładuj.')" class="menu-btn">
        <% }else{ %>
