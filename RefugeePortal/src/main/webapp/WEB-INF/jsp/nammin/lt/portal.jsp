...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Atsijungti</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Registracija baigta</p>
        </div>
        ...
        <a href="javascript:alert('Prašome kreiptis į "Messenger" dėl medicininių klausimų. Jei jau buvo apklausta, prašau iš naujo įkelti.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ar norite atsijungti?")){
            return false;
        }else{
            form_logout.submit();
        }
