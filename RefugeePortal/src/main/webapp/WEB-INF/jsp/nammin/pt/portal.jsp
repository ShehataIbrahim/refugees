...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Sair</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">O registro está completo</p>
        </div>
        ...
        <a href="javascript:alert('Por favor, obtenha consultas médicas no Messenger. Se você já foi entrevistado, por favor recarregue.')" class="menu-btn">
        <% }else{ %>
