...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">A registrazioni hè cumpletu</p>
        </div>
        ...
        <a href="javascript:alert('Fate dunque mèdici nantu à Messenger. Se avete digià statu entrevista, ricaricate.')" class="menu-btn">
        <% }else{ %>
