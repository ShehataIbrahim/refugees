...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('U registru medico elettronicu serà presentatu.')">Registrazioni medichi elettronii</a></p>
	</div>
		...
		<form action="" method="post" id="">
			...
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					...
					<li><input type="radio" name="regulation-01" value="" id="gender_check2"><label for="woman">Female</label></li>
				</ul>
			</div>
			...
			<p class="input-vertical">
				<label>Phone number</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
			...
			<p class="input-vertical">
				<label>Luoghi di residenza</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>Caretaker</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>Tinta di famiglia (persona)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>Residence card · Un certificatu permanente di residente permanente</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>Data di cadenza</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>Status di residenza</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>Data di cadenza</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('A información basica fixa.');">Correzione</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
