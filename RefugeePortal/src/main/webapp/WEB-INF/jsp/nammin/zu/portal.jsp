...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Ukubhalisa kuqediwe</p>
        </div>
        ...
        <a href="javascript:alert('Sicela uthole imibuzo yezokwelapha ku-Messenger. Uma usuvele uxoxwa sicela ulayishe kabusha.')" class="menu-btn">
        <% }else{ %>
