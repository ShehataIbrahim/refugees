...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ອອກຈາກລະບົບ</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">ການລົງທະບຽນແມ່ນສໍາເລັດ</p>
        </div>
        ...
        <a href="javascript:alert('ກະລຸນາສອບຖາມທາງການແພດທີ່ Messenger. ຖ້າທ່ານໄດ້ຮັບການສໍາພາດແລ້ວກະຣຸນາໂຫລດຄືນໃຫມ່.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("ທ່ານຕ້ອງການອອກຈາກລະບົບ?")){
            return false;
        }else{
            form_logout.submit();
        }
