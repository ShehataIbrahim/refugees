...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Elŝaltiĝu</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registriĝo estas kompleta</p>
        </div>
        ...
        <a href="javascript:alert('Bonvolu ricevi medicinajn demandojn ĉe Messenger. Se vi jam estis intervjuita bonvolu reŝargi.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ĉu vi volas elsalti?")){
            return false;
        }else{
            form_logout.submit();
        }
