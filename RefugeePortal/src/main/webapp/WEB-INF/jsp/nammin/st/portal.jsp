...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Ho kena-kenana</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Ho ngolisa ho feletse</p>
        </div>
        ...
        <a href="javascript:alert('Ka kopo fumana lipatlisiso tsa bongaka ho Messenger. Haeba o se o kile oa buisanoa ka kopo, o ka boela oa buisana.')" class="menu-btn">
        <% }else{ %>
