...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Ingia</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Usajili umekamilika</p>
        </div>
        ...
        <a href="javascript:alert('Tafadhali pata maswali ya matibabu kwa Mtume. Ikiwa tayari umehojiwa tafadhali rejesha upya.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Unataka kuingia nje?")){
            return false;
        }else{
            form_logout.submit();
        }
