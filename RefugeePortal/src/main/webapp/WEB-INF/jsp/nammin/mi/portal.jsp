...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Whakaaturanga</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kua oti te rēhita</p>
        </div>
        ...
        <a href="javascript:alert('Tena koa kia uiuia nga korero hauora i te Messenger. Mena kua uiuia koe kia pai ake te tango.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Kei te hiahia koe ki te takiuru?")){
            return false;
        }else{
            form_logout.submit();
        }
