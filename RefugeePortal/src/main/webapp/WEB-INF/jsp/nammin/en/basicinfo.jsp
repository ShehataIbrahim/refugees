...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('The electronic medical record will be displayed.')">Electronic medical records</a></p>
	</div>
	...
	<div id="basic-informations">
		<form action="" method="post" id="">
			...
			<p class="input-vertical">
				<label>place of birth</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>Career</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>Country of Citizenship</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>Place of residence</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
			...
			<p class="input-vertical"><label>Residence card · Special permanent resident certificate number</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>expiration date</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>Status of residence</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>Expiration date</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('Fixed basic information.');">Correction</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
