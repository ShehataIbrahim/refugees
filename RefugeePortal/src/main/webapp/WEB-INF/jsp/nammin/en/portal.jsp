...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registration has been completed</p>
        </div>
        ...
        <a href="javascript:alert('Please get medical inquiries at Messenger. If you have already been interviewed please reload.')" class="menu-btn">
        <% }else{ %>
