...
<div id="wrapper">
	...
	<div id="medical-inquiry-data">
		<form action="" method="post" id="">
			...
			<div class="input-radio">
				<p>Are there abnormal appetite?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Do you have subjective symptoms?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>When do you have subjective symptoms?</label><textarea rows="1" cols="" id="q4"></textarea>
			</p>
			<p class="input-vertical adjustment-bottom-margin">
				<label>What are the symptoms?</label><textarea rows="1" cols="" id="q5"></textarea>
			</p>
			<div class="input-radio">
				<p> Have you been consulted recently?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Have you ever received hospitalization surgery?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>What is the name of the disease at that time?</label><textarea rows="1" cols="" id="q8"></textarea>
			</p>
			<div class="input-radio">
				<p>Is there any medicine you are currently drinking?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>COPD</h2>
			<p class="input-vertical adjustment-bottom-margin"><label>How many cigarettes do you smoke a day? <br/> (today)</label><input type="number" pattern="\d*" id="q11"></p>
			<div class="input-radio">
				<p>Do you often get stuck up after getting up in the morning?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Do you often have wheezes (Zezei, Hugh Hugh)?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Have you snoreed in the last 3 months?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Have you been told by your family that breathing may stop during sleep in the past 3 months?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Did you feel sleepy and sleeping or falling asleep in the daytime or during the last 3 months?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Have you been told that your blood sugar level is high?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Does your family have diabetes?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="btn-large" style="margin-top:48px"><a href="javascript:void(0)" onclick="alert('We corrected the inquiry contents.');">Correction</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
