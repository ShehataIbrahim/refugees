...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Log keluar</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Pendaftaran selesai</p>
        </div>
        ...
        <a href="javascript:alert('Sila dapatkan pertanyaan perubatan di Messenger. Sekiranya anda telah ditemuramah sila tambah nilai.')" class="menu-btn">
        <% }else{ %>
