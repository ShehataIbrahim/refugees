...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Registracija je gotova</p>
        </div>
        ...
        <a href="javascript:alert('Molimo Vas da potražite medicinske upite u Messengeru. Ako ste već intervjuirali, ponovo učitajte.')" class="menu-btn">
        <% }else{ %>
