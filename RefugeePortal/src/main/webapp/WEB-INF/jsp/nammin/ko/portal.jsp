...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">로그 아웃</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">등록이 완료되었습니다</p>
        </div>
        ...
        <a href="javascript:alert('Messenger에서 문진을 받으십시오. 이미 문진을 받으면 다시로드하십시오.')" class="menu-btn">
        <% }else{ %>
