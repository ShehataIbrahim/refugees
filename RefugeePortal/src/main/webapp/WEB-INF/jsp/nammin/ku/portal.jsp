...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Pîroz qedandin</p>
        </div>
        ...
        <a href="javascript:alert('Ji kerema xwe re li ser pêxemberê lêpirsînê derman bikin. Heke ji we re hevpeyvîn bûye kerema xwe dîsa barkirin.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ma hûn dixwazin bixwazin?")){
            return false;
        }else{
            form_logout.submit();
        }
