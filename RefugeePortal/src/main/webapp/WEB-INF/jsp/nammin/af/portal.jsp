...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Teken uit</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registrasie is voltooi</p>
        </div>
        ...
        <a href="javascript:alert('Kry asseblief mediese navrae by Messenger. As u reeds 'n onderhoud gevoer het, herlaai asseblief.')" class="menu-btn">
        <% }else{ %>
