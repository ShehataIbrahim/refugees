...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">чыгуу</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Каттоо аяктады</p>
        </div>
        ...
        <a href="javascript:alert('Элчисине маегинде жооп жагууга. маегинде жооп берсе, буга чейин кайра окудум.')" class="menu-btn">
        <% }else{ %>
