...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Faʻaaliga</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Faamauina e maeʻa</p>
        </div>
        ...
        <a href="javascript:alert('Faamolemole ia maua ni suesuega faafomaʻi i le Messenger. Afai ua faʻatalanoaina oe faʻamolemole toe sii mai.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("E te fia alu i fafo?")){
            return false;
        }else{
            form_logout.submit();
        }
