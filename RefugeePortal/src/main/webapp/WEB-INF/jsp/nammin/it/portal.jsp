...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Esci</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">La registrazione è completa</p>
        </div>
        ...
        <a href="javascript:alert('Si prega di ottenere richieste mediche a Messenger. Se sei già stato intervistato per favore ricarica.')" class="menu-btn">
        <% }else{ %>
