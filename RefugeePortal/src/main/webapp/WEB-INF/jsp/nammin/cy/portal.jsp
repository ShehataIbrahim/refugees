...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Logout</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Mae'r cofrestriad wedi'i gwblhau</p>
        </div>
        ...
        <a href="javascript:alert('Gallwch gael ymholiadau meddygol yn Messenger. Os ydych eisoes wedi cael eich cyfweld, ail-lwythwch.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ydych chi eisiau logio allan?")){
            return false;
        }else{
            form_logout.submit();
        }
