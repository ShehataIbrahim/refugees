...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">გამოსვლა</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">რეგისტრაცია დასრულებულია</p>
        </div>
        ...
        <a href="javascript:alert('გთხოვთ, მიიღოთ სამედიცინო გამოკითხვა მესენჯში. თუ უკვე გამოკითხული გაქვთ, გთხოვთ, განაახლეთ.')" class="menu-btn">
        <% }else{ %>
