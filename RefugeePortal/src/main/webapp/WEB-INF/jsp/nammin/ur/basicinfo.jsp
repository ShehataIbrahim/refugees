...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('الیکٹرانک میڈیکل ریکارڈ دکھایا جائے گا.')">الیکٹرانک طبی ریکارڈ</a></p>
	</div>
		...
		<form action="" method="post" id="">
			...
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					<li><input type="radio" name="regulation-01" value="" id="gender_check1" checked><label for="man">مرد</label></li>
			...
			<p class="input-vertical">
				<label>کیریئر</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>قومیت</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>رہائشی جگہ</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>نگرانی</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>خاندانی سائز (شخص)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>رہائش کارڈ · خصوصی مستقل رہائشی سرٹیفکیٹ نمبر</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>ختم ہونے کی تاریخ</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>رہائشی حیثیت</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>ختم ہونے کی تاریخ</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('فکسڈ بنیادی معلومات.');">اصلاح</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
