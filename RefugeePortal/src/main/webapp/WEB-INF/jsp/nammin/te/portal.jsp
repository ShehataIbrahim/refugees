...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">లాగ్ అవుట్</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">నమోదు పూర్తయింది</p>
        </div>
        ...
        <a href="javascript:alert('దయచేసి మెసెంజర్లో వైద్య విచారణలను పొందండి. మీరు ఇంతకు ముందు ఇంటర్వ్యూ చేస్తే దయచేసి రీలోడ్ చేయండి.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("మీరు లాగ్ అవుట్ చేయాలనుకుంటున్నారా?")){
            return false;
        }else{
            form_logout.submit();
        }
