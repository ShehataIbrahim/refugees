...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('Zobrazí sa elektronický lekársky záznam.')">Elektronické zdravotné záznamy</a></p>
	</div>

	<div id="basic-informations">
		<form action="" method="post" id="">
			<p class="input-vertical"><label>celé meno</label><input type="text" id="name"></p>
			<div class="input-radio">
				<p>rod</p>
				<ul class="regulation-switch flex-between">
					<li><input type="radio" name="regulation-01" value="" id="gender_check1" checked><label for="man">samec</label></li>
			...
			<p class="input-vertical">
				<label>Telefónne číslo</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
				<label>pôrod</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>povolania</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>národnosť</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>Miesto bydliska</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>sponzor</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>Veľkosť rodiny (osoba)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>Residence card · Špeciálne číslo certifikátu s trvalým pobytom</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>Dátum vypršania platnosti</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>Stav pobytu</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>Dátum vypršania platnosti</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('Pevné základné informácie.');">oprava</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
