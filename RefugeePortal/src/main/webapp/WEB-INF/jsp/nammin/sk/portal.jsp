...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Odhlásiť</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registrácia je dokončená</p>
        </div>
        ...
        <a href="javascript:alert('Dotazujte sa na Messenger. Ak ste už dostali rozhovor, znova načítajte.')" class="menu-btn">
        <% }else{ %>
