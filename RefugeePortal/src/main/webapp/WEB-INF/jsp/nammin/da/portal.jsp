...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Log ud</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Registreringen er afsluttet</p>
        </div>
        ...
        <a href="javascript:alert('Vær venlig at få lægeundersøgelser hos Messenger. Hvis du allerede er blevet interviewet, bedes du genindlæse.')" class="menu-btn">
        <% }else{ %>
