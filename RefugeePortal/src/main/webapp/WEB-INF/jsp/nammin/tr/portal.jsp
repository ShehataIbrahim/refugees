...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Oturumu</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kayıt tamamlandı</p>
        </div>
        ...
        <a href="javascript:alert('Lütfen Messenger'dan tıbbi sorularınız alın. Röportaj yaptıysanız lütfen tekrar yükleyin.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Çıkış yapmak istermisin?")){
            return false;
        }else{
            form_logout.submit();
        }
