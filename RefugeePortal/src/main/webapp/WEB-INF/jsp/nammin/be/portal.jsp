...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">выйсці</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">рэгістрацыя завершана</p>
        </div>
        ...
        <a href="javascript:alert('Калі ласка, у адказ на інтэрв'ю ў Messenger. Калі ласка, ўжо перачытаў, калі адказ на інтэрв'ю.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Вы ўпэўненыя, што жадаеце выйсці.")){
            return false;
        }else{
            form_logout.submit();
        }
