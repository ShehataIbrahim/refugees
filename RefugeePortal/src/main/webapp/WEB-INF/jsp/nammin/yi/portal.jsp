...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">לאָגאָוט</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">רעגיסטראַציע איז גאַנץ</p>
        </div>
        ...
        <a href="javascript:alert('ביטע באַקומען מעדיציניש ינקוויריעס אין מעסינדזשער. אויב איר האָט שוין ינטערוויוז ביטע רילאָוד.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("צי איר ווילן צו קלאָץ אויס?")){
            return false;
        }else{
            form_logout.submit();
        }
