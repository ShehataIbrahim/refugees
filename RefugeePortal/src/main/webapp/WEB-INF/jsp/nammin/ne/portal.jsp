...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">लगआउट</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">दर्ता पूरा भयो</p>
        </div>
        ...
        <a href="javascript:alert('मेसेन्जरमा कृपया चिकित्सा जाँचहरू पाउनुहोस्। यदि तपाईंले पहिले नै साक्षात्कार गर्नुभयो भने पुन: लोड गर्नुहोस्।')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("के तपाई लग आउट गर्न चाहानुहुन्छ?")){
            return false;
        }else{
            form_logout.submit();
        }
