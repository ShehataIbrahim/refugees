...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('इलेक्ट्रोनिक मेडिकल रेकर्ड प्रदर्शित हुनेछ।')">इलेक्ट्रोनिक मेडिकल रेकर्ड</a></p>
	</div>

	<div id="basic-informations">
		<form action="" method="post" id="">
			<p class="input-vertical"><label>नाम</label><input type="text" id="name"></p>
			...
			<p class="input-vertical">
				<label>फोन नम्बर</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
				<label>उत्पत्ति</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>क्यारियर</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>राष्ट्रियता</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>निवासको स्थान</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>क्यारेक्टर</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>पारिवारिक आकार (व्यक्ति)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>निवास कार्ड · विशेष स्थायी निवासी प्रमाणपत्र नम्बर</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>समयावधि मिति</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>निवासको स्थिति</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>समयावधि मिति</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('निश्चित आधारभूत जानकारी।');">सुधार</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
