...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Ukungena ngemvume</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Ukubhaliswa kuphelile</p>
        </div>
        ...
        <a href="javascript:alert('Nceda ufumane imibuzo yonyango kuMthunywa. Ukuba usuvele udliwano-ndlebe nceda ulayishe kwakhona.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ngaba ufuna ukuphuma?")){
            return false;
        }else{
            form_logout.submit();
        }
