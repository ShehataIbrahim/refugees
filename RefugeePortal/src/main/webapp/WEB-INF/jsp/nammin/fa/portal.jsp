...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">خروج</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">ثبت نام کامل است</p>
        </div>
        ...
        <a href="javascript:alert('لطفا سوالات پزشکی را در مسنجر دریافت کنید. اگر قبلا مصاحبه کرده اید، مجددا بارگیری کنید.')" class="menu-btn">
        <% }else{ %>
