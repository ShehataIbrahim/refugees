...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Log a-mach</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Tha clàradh crìochnaichte</p>
        </div>
        ...
        <a href="javascript:alert('Feuch ceistean meidigeach aig Messenger. Ma tha thu air agallamhan mu thràth ath-nuadhachadh.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("A bheil thu airson logadh a-mach?")){
            return false;
        }else{
            form_logout.submit();
        }
