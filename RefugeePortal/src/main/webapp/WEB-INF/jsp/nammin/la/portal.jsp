...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Log sunt</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registration est complebitur</p>
        </div>
        ...
        <a href="javascript:alert('Propter placere in colloquio apud angelum. Si placet, iam legere rursus responsio ad colloquium.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Esne certus vos volo ut e log.")){
            return false;
        }else{
            form_logout.submit();
        }
