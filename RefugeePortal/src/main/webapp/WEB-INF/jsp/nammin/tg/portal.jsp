...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Баромад</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Бақайдгирӣ ба анҷом мерасад</p>
        </div>
        ...
        <a href="javascript:alert('Лутфан дархости тиббиро дар Паём расонед. Агар шумо аллакай мусоҳиба шуда бошед, лутфан бор кунед.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Оё шумо мехостед, ки гузоред?")){
            return false;
        }else{
            form_logout.submit();
        }
