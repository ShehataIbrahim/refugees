...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Tancar sessió</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">La inscripció s'ha completat</p>
        </div>
        ...
        <a href="javascript:alert('Per obtenir consultes mèdiques a Messenger. Si ja has estat entrevistat, torna a carregar.')" class="menu-btn">
        <% }else{ %>
