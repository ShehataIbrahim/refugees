...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kunyora kwakakwana</p>
        </div>
        ...
        <a href="javascript:alert('Ndapota tora mibvunzo yezvechiremba kuMutumwa. Kana wakatove wabvunzurudzwa tapota torazve.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Iwe unoda kubuda kunze?")){
            return false;
        }else{
            form_logout.submit();
        }
