...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Ելք</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Գրանցումը ավարտված է</p>
        </div>
        ...
        <a href="javascript:alert('Խնդրում ենք բժշկական զննում ստանալ Մեսսին: Եթե ​​արդեն հարցաքննվել եք, վերբեռնեք:')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ցանկանում եք դուրս գալ:")){
            return false;
        }else{
            form_logout.submit();
        }
