...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Pendaftaran rampung</p>
        </div>
        ...
        <a href="javascript:alert('Mangga njaluk pitakonan medis ing Messenger. Yen sampeyan wis diwawancarai, mangga refresh.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Sampeyan pengin metu?")){
            return false;
        }else{
            form_logout.submit();
        }
