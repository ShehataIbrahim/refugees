...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">लॉगआउट</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">नोंदणी पूर्ण आहे</p>
        </div>
        ...
        <a href="javascript:alert('मेसेंजरच्या वैद्यकीय चौकशी करा. आपण आधीच मुलाखत गेले असल्यास कृपया पुन्हा लोड करा')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("आपण लॉग आउट करू इच्छिता?")){
            return false;
        }else{
            form_logout.submit();
        }
