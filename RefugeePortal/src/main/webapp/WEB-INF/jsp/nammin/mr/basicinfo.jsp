...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('इलेक्ट्रॉनिक मेडिकल रेकॉर्ड प्रदर्शित केले जाईल.')">इलेक्ट्रॉनिक वैद्यकीय रेकॉर्ड</a></p>
	</div>

	<div id="basic-informations">
		<form action="" method="post" id="">
			<p class="input-vertical"><label>नाव</label><input type="text" id="name"></p>
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					...
					<li><input type="radio" name="regulation-01" value="" id="gender_check2"><label for="woman">स्त्री</label></li>
				</ul>
			</div>
			...
			<p class="input-vertical">
				<label>मूळ</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>करिअर</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>राष्ट्रीयत्व</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>निवास स्थान</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>काळजीवाहक</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>कौटुंबिक आकार (व्यक्ती)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>निवास कार्ड · विशेष स्थायी निवासी प्रमाणपत्र क्रमांक</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>कालबाह्यता तारीख</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>राहण्याचा दर्जा</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>कालावधी समाप्ती तारीख</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('मुदत मूलभूत माहिती');">सुधारणा</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
