...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ออกจากระบบ</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">การลงทะเบียนเสร็จสมบูรณ์แล้ว</p>
        </div>
        ...
        <a href="javascript:alert('โปรดสอบถามแพทย์ที่ Messenger หากคุณได้รับการสัมภาษณ์แล้วโปรดโหลดซ้ำ')" class="menu-btn">
        <% }else{ %>
