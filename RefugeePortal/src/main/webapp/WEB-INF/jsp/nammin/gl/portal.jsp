...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Saír</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">A inscrición está completa</p>
        </div>
        ...
        <a href="javascript:alert('Consulta preguntas médicas en Messenger. Se xa foi entrevistado, volve cargar.')" class="menu-btn">
        <% }else{ %>
