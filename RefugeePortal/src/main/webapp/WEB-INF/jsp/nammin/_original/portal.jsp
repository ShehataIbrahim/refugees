...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">{翻訳ここから}ログアウト{ここまで翻訳}</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">{翻訳ここから}登録が完了しました{ここまで翻訳}</p>
        </div>
        ...
        <a href="javascript:alert('{翻訳ここから}Messengerで問診を受けてください。すでに問診を受けていれば再読み込みをしてください。{ここまで翻訳}')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("{翻訳ここから}ログアウトしますか。{ここまで翻訳}")){
            return false;
        }else{
            form_logout.submit();
        }
