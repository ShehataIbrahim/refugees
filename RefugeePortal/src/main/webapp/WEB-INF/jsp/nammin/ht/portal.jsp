...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Enskripsyon se konplè</p>
        </div>
        ...
        <a href="javascript:alert('Tanpri, jwenn kesyon medikal nan mesaje. Si ou te deja entèvyou tanpri reload.')" class="menu-btn">
        <% }else{ %>
