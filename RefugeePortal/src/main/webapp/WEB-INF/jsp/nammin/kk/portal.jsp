...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Шығу</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Тіркеу аяқталды</p>
        </div>
        ...
        <a href="javascript:alert('Паспортта дәрігерлік анықтамаларды алыңыз. Егер сұхбаттасаңыз, қайта жүктеңіз.')" class="menu-btn">
        <% }else{ %>
