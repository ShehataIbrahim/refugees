...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Mag-log out</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kumpleto na ang pagpaparehistro</p>
        </div>
        ...
        <a href="javascript:alert('Mangyaring kumuha ng mga medikal na katanungan sa Messenger. Kung nainterbyu ka na, mangyaring i-reload.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Gusto mo bang mag-log out?")){
            return false;
        }else{
            form_logout.submit();
        }
