...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ውጣ</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">ምዝገባው ተጠናቅቋል</p>
        </div>
        ...
        <a href="javascript:alert('እባክዎ በ Messenger ውስጥ የህክምና መረጃ ያግኙ. ቀድሞውኑ ቃለ-መጠይቅ ከተደረገ እባክዎ እንደገና ይጫኑ.')" class="menu-btn">
        <% }else{ %>
