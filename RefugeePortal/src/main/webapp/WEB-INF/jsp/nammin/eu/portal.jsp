...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Saioa itxi</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Izen-ematea beteta dago</p>
        </div>
        ...
        <a href="javascript:alert('Eskuratu medikuari buruzko kontsultak Messenger-en. Elkarrizketatu baduzu, berriro kargatu.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Saioa amaitu nahi al duzu?")){
            return false;
        }else{
            form_logout.submit();
        }
