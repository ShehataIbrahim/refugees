...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Akara</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Ndebanye aha zuru</p>
        </div>
        ...
        <a href="javascript:alert('Biko nweta nlele ahụike na ozi. Ọ bụrụ na enyoro gị ajụjụ ọnụ biko bubatagharịa.')" class="menu-btn">
        <% }else{ %>
