...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Déconnexion</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">L'inscription est complète</p>
        </div>
        ...
        <a href="javascript:alert('S'il vous plaît obtenir des demandes de renseignements médicaux à Messenger. Si vous avez déjà été interviewé, rechargez-le.')" class="menu-btn">
        <% }else{ %>
