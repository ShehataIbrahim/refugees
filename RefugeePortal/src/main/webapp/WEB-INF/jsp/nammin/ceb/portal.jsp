...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Pag-log out</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kompleto ang pagrehistro</p>
        </div>
        ...
        <a href="javascript:alert('Palihug pangayo og medical inquiry sa Messenger. Kon nakuha ka na nga giinterbyu, palihug pasabta.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Gusto ka bang mag-log out?")){
            return false;
        }else{
            form_logout.submit();
        }
