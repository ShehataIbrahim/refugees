...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Väljuge välja</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registreerimine on lõpetatud</p>
        </div>
        ...
        <a href="javascript:alert('Palun saatke Messengeris meditsiinilisi päringuid. Kui olete juba küsitletud, palun laadige uuesti.')" class="menu-btn">
        <% }else{ %>
