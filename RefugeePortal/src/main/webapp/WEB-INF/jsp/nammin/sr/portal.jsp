...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Одјава</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Регистрација је завршена</p>
        </div>
        ...
        <a href="javascript:alert('Молим вас да добијете медицинске информације у Мессенгер-у. Ако сте већ интервјуирани, поново учитајте.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Да ли желите да се одјавите?")){
            return false;
        }else{
            form_logout.submit();
        }
