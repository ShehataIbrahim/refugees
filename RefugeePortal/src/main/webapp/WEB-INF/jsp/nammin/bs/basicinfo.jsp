...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('Elektronski medicinski zapis će biti prikazan.')">Elektronski medicinski dokumenti</a></p>
	</div>
		...
		<form action="" method="post" id="">
			...
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					<li><input type="radio" name="regulation-01" value="" id="gender_check1" checked><label for="man">Muškarac</label></li>
					<li><input type="radio" name="regulation-01" value="" id="gender_check2"><label for="woman">Žensko</label></li>
				</ul>
			</div>
			...
			<p class="input-vertical">
				<label>Broj telefona</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
				<label>Poreklo</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>Karijera</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>Državljanstvo</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>Mesto boravka</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>Caretaker</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>Veličina porodice (osoba)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>Kartica boravka · Poseban broj certifikata za stalni boravak</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>Datum isteka</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('Osnovne osnovne informacije.');">Korekcija</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
