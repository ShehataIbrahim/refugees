...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Odjava</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registracija je završena</p>
        </div>
        ...
        <a href="javascript:alert('Molim vas da dobijete medicinske informacije u Messenger-u. Ako ste već intervjuirani, ponovo napunite.')" class="menu-btn">
        <% }else{ %>
