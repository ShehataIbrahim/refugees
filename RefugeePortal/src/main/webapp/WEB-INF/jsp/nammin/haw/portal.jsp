...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Loaʻa</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Ua piha ka inoa</p>
        </div>
        ...
        <a href="javascript:alert('Eʻoluʻolu, eʻimi i nā nīnau kelepona i kaʻelele. Inā ua nīnauʻiaʻoe i kēia manawa, e hoʻihoʻi.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Makemakeʻoe e puka i waho?")){
            return false;
        }else{
            form_logout.submit();
        }
