...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Atteikties</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Reģistrācija ir pabeigta</p>
        </div>
        ...
        <a href="javascript:alert('Lūdzu, sazinieties ar medicīnas pakalpojumu sniedzēju. Ja jums jau ir intervēti, lūdzu, atkārtoti ielādējiet.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Vai vēlaties atteikties?")){
            return false;
        }else{
            form_logout.submit();
        }
