...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Chiqish</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Ro'yxatdan o'tish tugallandi</p>
        </div>
        ...
        <a href="javascript:alert('Iltimos, Messenger'da tibbiy yordam so'rang. Agar siz allaqachon intervyu bergan bo'lsangiz, iltimos, qayta yuklang.')" class="menu-btn">
        <% }else{ %>
