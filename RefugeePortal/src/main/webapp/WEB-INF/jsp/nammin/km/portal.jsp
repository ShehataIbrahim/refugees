...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ចេញ</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">ការចុះឈ្មោះបានបញ្ចប់</p>
        </div>
        ...
        <a href="javascript:alert('សូមទទួលការសាកសួរវេជ្ជសាស្រ្តនៅឯកម្មវិធីផ្ញើសារ។ ប្រសិនបើអ្នកត្រូវបានសម្ភាសរួចហើយសូមដំណើរការឡើងវិញ។')" class="menu-btn">
        <% }else{ %>
