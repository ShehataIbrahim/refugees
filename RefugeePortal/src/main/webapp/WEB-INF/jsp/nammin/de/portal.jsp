...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Abmelden</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Die Registrierung ist abgeschlossen</p>
        </div>
        ...
        <a href="javascript:alert('Bitte erkundigen Sie sich bei Messenger nach medizinischen Fragen. Wenn Sie bereits interviewt wurden, laden Sie bitte neu.')" class="menu-btn">
        <% }else{ %>
