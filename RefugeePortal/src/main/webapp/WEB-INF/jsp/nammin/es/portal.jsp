...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Salir</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">El registro está completo</p>
        </div>
        ...
        <a href="javascript:alert('Por favor, obtenga consultas médicas en Messenger. Si ya ha sido entrevistado, vuelva a cargar.')" class="menu-btn">
        <% }else{ %>
