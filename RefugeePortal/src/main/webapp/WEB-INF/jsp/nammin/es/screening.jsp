...
<div id="wrapper">
	...
	<div id="medical-inquiry-data">
		<form action="" method="post" id="">
			<h2>Control de salud inicial</h2>
			...
			<div class="input-radio">
				<p>¿Tienes síntomas subjetivos?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>¿Cuándo tienes síntomas subjetivos?</label><textarea rows="1" cols="" id="q4"></textarea>
			</p>
			<p class="input-vertical adjustment-bottom-margin">
				<label>¿Cuáles son los síntomas?</label><textarea rows="1" cols="" id="q5"></textarea>
			</p>
			<div class="input-radio">
				<p> ¿Has sido consultado recientemente?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Alguna vez ha recibido una cirugía de hospitalización?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>¿Cuál es el nombre de la enfermedad en ese momento?</label><textarea rows="1" cols="" id="q8"></textarea>
			</p>
			<div class="input-radio">
				<p>¿Hay algún medicamento que esté bebiendo actualmente?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>COPD</h2>
			<p class="input-vertical adjustment-bottom-margin"><label>¿Cuántos cigarrillos fumas por día? <br/> (Libro / día)</label><input type="number" pattern="\d*" id="q11"></p>
			<div class="input-radio">
				<p>¿A menudo te quedas atrapado después de levantarte por la mañana?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Sueles tener sibilancias (Zezei, Hugh Hugh)?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Has roncado en los últimos 3 meses?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Su familia le ha dicho que la respiración puede detenerse durante el sueño en los últimos 3 meses?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Sintió sueño y durmió o se quedó dormido durante el día o durante los últimos 3 meses?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>¿Le han dicho que su nivel de azúcar en la sangre es alto?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="btn-large" style="margin-top:48px"><a href="javascript:void(0)" onclick="alert('Corregimos los contenidos de la consulta.');">Corrección</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
