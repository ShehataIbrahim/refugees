...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">log out</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Regjistrimi është i plotë</p>
        </div>
        ...
        <a href="javascript:alert('Ju lutemi merrni pyetje mjekësore në Messenger. Nëse jeni intervistuar tashmë, ju lutemi rifreskoni.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Dëshiron të identifikohesh?")){
            return false;
        }else{
            form_logout.submit();
        }
