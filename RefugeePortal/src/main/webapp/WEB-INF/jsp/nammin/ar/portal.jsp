...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">تسجيل الخروج</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">اكتمال التسجيل</p>
        </div>
        ...
        <a href="javascript:alert('يرجى الحصول على الاستفسارات الطبية في Messenger. إذا كنت قد أجريت مقابلة معك بالفعل ، فيرجى إعادة تحميلها.')" class="menu-btn">
        <% }else{ %>
