...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">התנתקות</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">ההרשמה הושלמה</p>
        </div>
        ...
        <a href="javascript:alert('נא לקבל שאלות רפואיות ב- Messenger. אם כבר ראיינו אנא טען מחדש.')" class="menu-btn">
        <% }else{ %>
