...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">kirjaudu ulos</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Rekisteröinti on valmis</p>
        </div>
        ...
        <a href="javascript:alert('Pyydä lääketieteellisiä kysymyksiä Messengerissä. Jos olet jo haastateltu, lataa uudelleen.')" class="menu-btn">
        <% }else{ %>
