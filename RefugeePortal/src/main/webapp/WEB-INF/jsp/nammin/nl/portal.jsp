...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Afmelden</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Registratie is voltooid</p>
        </div>
        ...
        <a href="javascript:alert('Raadpleeg medische vragen bij Messenger. Als je al bent geïnterviewd, herlaad dan.')" class="menu-btn">
        <% }else{ %>
