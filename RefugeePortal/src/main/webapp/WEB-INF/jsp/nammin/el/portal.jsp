...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Αποσύνδεση</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Η εγγραφή ολοκληρώθηκε</p>
        </div>
        ...
        <a href="javascript:alert('Παρακαλείσθε να λάβετε ιατρικά ερωτήματα στο Messenger. Αν έχετε ήδη πάρει συνέντευξη, παρακαλούμε ξαναφορτώστε.')" class="menu-btn">
        <% }else{ %>
