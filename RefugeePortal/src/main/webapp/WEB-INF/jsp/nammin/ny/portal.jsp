...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Lowani</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kulembetsa kwatha</p>
        </div>
        ...
        <a href="javascript:alert('Chonde funsani zachipatala kwa Messenger. Ngati mwafunsidwa kale chonde tithandizani.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Kodi mukufuna kutuluka?")){
            return false;
        }else{
            form_logout.submit();
        }
