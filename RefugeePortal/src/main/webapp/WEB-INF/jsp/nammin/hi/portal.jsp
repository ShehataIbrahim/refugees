...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">लॉग आउट करें</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">पंजीकरण पूरा हो गया है</p>
        </div>
        ...
        <a href="javascript:alert('मेसेंजर पर मेडिकल पूछताछ प्राप्त करें यदि आपके पास पहले ही साक्षात्कार लिया गया है तो कृपया पुनः लोड करें।')" class="menu-btn">
        <% }else{ %>
