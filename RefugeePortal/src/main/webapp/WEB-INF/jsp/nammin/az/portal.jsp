...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Çıxın</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Qeydiyyat tamamlandı</p>
        </div>
        ...
        <a href="javascript:alert('Xahiş edirəm, Peyğəmbərdən soruşun. Əgər artıq görüşsəydinizsə, yenidən yükləyin.')" class="menu-btn">
        <% }else{ %>
