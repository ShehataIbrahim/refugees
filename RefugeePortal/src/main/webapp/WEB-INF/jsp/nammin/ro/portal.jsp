...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Înregistrarea este completă</p>
        </div>
        ...
        <a href="javascript:alert('Vă rugăm să primiți întrebări medicale la Messenger. Dacă ați fost deja intervievat, vă rugăm să reîncărcați.')" class="menu-btn">
        <% }else{ %>
