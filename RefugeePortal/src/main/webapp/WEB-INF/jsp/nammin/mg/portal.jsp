...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">miditra avy</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Feno fanoratana</p>
        </div>
        ...
        <a href="javascript:alert('Azafady azafady ny fangatahana ara-pitsaboana amin'ny irak'Andriamanitra. Raha efa nadinadinina ianao, azafady avereno.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Te-hivoaka ve ianao?")){
            return false;
        }else{
            form_logout.submit();
        }
