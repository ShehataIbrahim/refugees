...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Гарах</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Бүртгэл дууссан</p>
        </div>
        ...
        <a href="javascript:alert('Радио дээр эрүүл мэндийн лавлагаа аваарай. Хэрэв та аль хэдийн ярилцсан бол дахин ачаална уу.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Та гарахыг хүсч байна уу?")){
            return false;
        }else{
            form_logout.submit();
        }
