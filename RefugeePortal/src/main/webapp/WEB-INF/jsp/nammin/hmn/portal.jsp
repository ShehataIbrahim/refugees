...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Kev sau npe tiav lawm</p>
        </div>
        ...
        <a href="javascript:alert('Thov mus nug kev nug ntaub ntawv ntawm tus tub txib. Yog tias koj tau raug xam phaj thov rov qab.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Koj puas xav sau tawm?")){
            return false;
        }else{
            form_logout.submit();
        }
