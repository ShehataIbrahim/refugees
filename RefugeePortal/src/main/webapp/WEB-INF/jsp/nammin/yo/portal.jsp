...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Iforukọ silẹ ni pipe</p>
        </div>
        ...
        <a href="javascript:alert('Jọwọ gba awọn iwadii egbogi ni ojise. Ti o ba ti ni ibeere tẹlẹ jọwọ gbe afẹyinti.')" class="menu-btn">
        <% }else{ %>
