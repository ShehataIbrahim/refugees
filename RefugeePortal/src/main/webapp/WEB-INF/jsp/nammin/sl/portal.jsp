...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registracija je končana</p>
        </div>
        ...
        <a href="javascript:alert('Prosim, dobite zdravniške poizvedbe pri Messengerju. Če ste že bili intervjuvani, ponovno naložite.')" class="menu-btn">
        <% }else{ %>
