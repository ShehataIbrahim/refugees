...
<div id="wrapper">
	...
	<div id="medical-inquiry-data">
		<form action="" method="post" id="">
			<h2>Začetni zdravstveni pregled</h2>
			<div class="input-radio">
				<p>Ali imate alergije?</p>
			...
			<div class="input-radio">
				<p>Ali obstaja nenormalni apetit?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>Notranja medicina</h2>
			<div class="input-radio">
				<p>Imate subjektivne simptome?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>Kdaj imate subjektivne simptome?</label><textarea rows="1" cols="" id="q4"></textarea>
			</p>
			<p class="input-vertical adjustment-bottom-margin">
				<label>Kakšni so simptomi?</label><textarea rows="1" cols="" id="q5"></textarea>
			</p>
			<div class="input-radio">
				<p> Ste se nedavno posvetovali?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Ali ste kdaj prejeli operacijo hospitalizacije?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>Kakšno je ime bolezni v tistem času?</label><textarea rows="1" cols="" id="q8"></textarea>
			</p>
			<div class="input-radio">
				<p>Ali obstaja kakšno zdravilo, ki ga trenutno pijete?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>KOPB</h2>
			<p class="input-vertical adjustment-bottom-margin"><label>Koliko cigaret kadite na dan? <br/> (Knjiga / dan)</label><input type="number" pattern="\d*" id="q11"></p>
			<div class="input-radio">
				<p>Ali se pogosto zaljubiš, potem ko vstaneš zjutraj?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Imate pogosto piskanje (Zezei, Hugh Hugh)?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>Dihalna medicina</h2>
			<div class="input-radio">
				<p>Ali ste v zadnjih 3 mesecih hramili?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Ali vam je družina povedala, da se lahko dihanje v zadnjih 3 mesecih ustavi med spanjem?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Ste se počutili zaspani in spali ali zaspali dneve ali zadnjih 3 mesecev?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Ali ste bili povedali, da je raven sladkorja v krvi visoka?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Ali ima vaša družina sladkorno bolezen?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="btn-large" style="margin-top:48px"><a href="javascript:void(0)" onclick="alert('Popravili smo vsebino poizvedbe.');">Popravek</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
