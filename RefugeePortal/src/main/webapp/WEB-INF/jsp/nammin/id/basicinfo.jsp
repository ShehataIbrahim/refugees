...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('Rekam medis elektronik akan ditampilkan.')">Rekam medis elektronik</a></p>
	</div>
		...
		<form action="" method="post" id="">
			...
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					<li><input type="radio" name="regulation-01" value="" id="gender_check1" checked><label for="man">Laki-laki</label></li>
			...
			<p class="input-vertical">
				<label>Nomor telepon</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
			...
			<p class="input-vertical">
				<label>Kebangsaan</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
			...
			<p class="input-vertical"><label>Ukuran keluarga (orang)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>Kartu tempat tinggal · Nomor residen permanen khusus</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
            ...
            <p class="input-vertical">
                <label>Status tempat tinggal</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>Tanggal kedaluwarsa</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('Memperbaiki informasi dasar.');">Koreksi</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
