...
<div id="wrapper">
	<div class="header" id="header-bg-basic-info">
		<p>Personal</p>
		<p><a href="javascript:alert('De elektroanyske medyske list wurdt werjûn.')">Elektroanyske dokuminten</a></p>
	</div>

	<div id="basic-informations">
		<form action="" method="post" id="">
			<p class="input-vertical"><label>Namme</label><input type="text" id="name"></p>
			<div class="input-radio">
				...
				<ul class="regulation-switch flex-between">
					...
					<li><input type="radio" name="regulation-01" value="" id="gender_check2"><label for="woman">Frou</label></li>
				</ul>
			</div>
			...
			<p class="input-vertical">
				<label>Telefoannûmer</label><input type="number" pattern="\d*" id="tel"></textarea>
			</p>
			<p class="input-vertical">
				<label>Oarsprong</label><textarea rows="1" cols="" id="from"></textarea>
			</p>
			<p class="input-vertical">
				<label>Karriêre</label><textarea rows="1" cols="" id="job"></textarea>
			</p>
			<p class="input-vertical">
				<label>Nationaliteit</label><textarea rows="1" cols="" id="country"></textarea>
			</p>
			<p class="input-vertical">
				<label>Plak fan ferbliuw</label><textarea rows="1" cols="" id="address"></textarea>
			</p>
			<p class="input-vertical">
            				<label>Caretaker</label><textarea rows="1" cols="" id="supporter"></textarea>
            </p>
			<p class="input-vertical"><label>Famylgrutte (persoan)</label><input type="number" pattern="\d*" id="family_count"></p>
			<p class="input-vertical"><label>Residinsjekaart · Spesjale permaninte bewennersnût-nûmer</label><input type="number" pattern="\d*" id="zairyu_card_num"></p>
			<div class="input-horizon">
				<p>Ferfiersdatum</p>
				<ul>
            ...
            <p class="input-vertical">
                <label>Status fan ferbliuw</label><textarea rows="1" cols="" id="zairyu_sikaku"></textarea>
            </p>
			<div class="input-horizon">
				<p>Ferfiersdatum</p>
				<ul>
			...
			<p class="btn-large" style="margin-top:52px"><a href="javascript:void(0)" onclick="alert('Fêste basisynformaasje.');">Korreksje</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
