...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Registraasje is foltôge</p>
        </div>
        ...
        <a href="javascript:alert('Meitsje medyske fersiken by Messenger. As jo ​​al ynterviewd binne, ferfange jo opnij.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Wolle jo jo útlogje?")){
            return false;
        }else{
            form_logout.submit();
        }
