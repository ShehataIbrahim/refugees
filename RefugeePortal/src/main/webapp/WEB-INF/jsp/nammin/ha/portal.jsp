...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Binciken</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Rijista ya cika</p>
        </div>
        ...
        <a href="javascript:alert('Don Allah a sami bincike na likita a Manzo. Idan an riga an yi hira da ku don Allah sake saukewa.')" class="menu-btn">
        <% }else{ %>
