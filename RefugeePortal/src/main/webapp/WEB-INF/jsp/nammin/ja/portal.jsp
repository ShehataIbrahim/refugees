...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ログアウト</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">登録が完了しました</p>
        </div>
        ...
        <a href="javascript:alert('Messengerで問診を受けてください。すでに問診を受けていれば再読み込みをしてください。')" class="menu-btn">
        <% }else{ %>
