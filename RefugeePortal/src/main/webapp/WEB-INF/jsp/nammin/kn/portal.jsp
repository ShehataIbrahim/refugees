...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">ಲಾಗ್ಔಟ್</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">ನೋಂದಣಿ ಪೂರ್ಣಗೊಂಡಿದೆ</p>
        </div>
        ...
        <a href="javascript:alert('ದಯವಿಟ್ಟು ಮೆಸೆಂಜರ್ನಲ್ಲಿ ವೈದ್ಯಕೀಯ ವಿಚಾರಣೆಗಳನ್ನು ಪಡೆಯಿರಿ. ನೀವು ಈಗಾಗಲೇ ಸಂದರ್ಶನ ಮಾಡಿದ್ದರೆ ದಯವಿಟ್ಟು ಮರುಲೋಡ್ ಮಾಡಿ.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("ನೀವು ಲಾಗ್ ಔಟ್ ಮಾಡಲು ಬಯಸುವಿರಾ?")){
            return false;
        }else{
            form_logout.submit();
        }
