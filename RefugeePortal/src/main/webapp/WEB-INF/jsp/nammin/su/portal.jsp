...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">kaluar</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Pendaptaran geus réngsé</p>
        </div>
        ...
        <a href="javascript:alert('Mangga Dina respon kana wawancara di Rasul. Mangga geus ulang maca lamun respon kana wawancara.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Anjeun yakin rék kaluar.")){
            return false;
        }else{
            form_logout.submit();
        }
