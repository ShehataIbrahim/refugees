...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Вийти</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Реєстрація завершена</p>
        </div>
        ...
        <a href="javascript:alert('Будь ласка, отримайте медичні запити на Messenger. Якщо ви вже взяли інтерв'ю, будь ласка, перезавантажте.')" class="menu-btn">
        <% }else{ %>
