...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Qaadashada</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Diiwaangelintu waa dhammaatay</p>
        </div>
        ...
        <a href="javascript:alert('Fadlan ka raadso wareysiga daaweynta Rasuulka. Haddii aad horey wareysi la yeelatay fadlan dib u cusbooneysii.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Ma rabtaa inaad gasho?")){
            return false;
        }else{
            form_logout.submit();
        }
