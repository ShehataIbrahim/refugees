...
<div id="wrapper">
    ...
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Aschreiwung ass komplett</p>
        </div>
        ...
        <a href="javascript:alert('Mellt ärer medizinescher Ufro un Messenger. Wann Dir schonn interviewt hutt, lued Iech op.')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("Wëllt Dir ausloggen?")){
            return false;
        }else{
            form_logout.submit();
        }
