...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Đăng xuất</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">Đăng ký hoàn tất</p>
        </div>
        ...
        <a href="javascript:alert('Vui lòng nhận được yêu cầu y tế tại Messenger. Nếu bạn đã được phỏng vấn, vui lòng tải lại.')" class="menu-btn">
        <% }else{ %>
