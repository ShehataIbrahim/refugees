...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">লগ আউট করুন</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>News</p>
            <p id="show-msg">নিবন্ধন সম্পূর্ণ</p>
        </div>
        ...
        <a href="javascript:alert('দয়া করে রসূলের চিকিৎসা অনুসন্ধান করুন। আপনি ইতিমধ্যে ইন্টারভিউ করা হয়েছে দয়া করে পুনরায় লোড করুন।')" class="menu-btn">
        <% }else{ %>
...
<script>
    function confirmLogout(){
        if(!confirm("আপনি লগ আউট করতে চান?")){
            return false;
        }else{
            form_logout.submit();
        }
