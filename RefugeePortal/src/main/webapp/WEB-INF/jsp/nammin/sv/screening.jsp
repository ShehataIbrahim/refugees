	...
	<div id="medical-inquiry-data">
		<form action="" method="post" id="">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>När har du subjektiva symptom?</label><textarea rows="1" cols="" id="q4"></textarea>
			</p>
			<p class="input-vertical adjustment-bottom-margin">
				<label>Vad är symtomen?</label><textarea rows="1" cols="" id="q5"></textarea>
			</p>
			<div class="input-radio">
				<p> Har du nyligen hört?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Har du någonsin fått sjukhusvistelse operation?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="input-vertical adjustment-bottom-margin">
				<label>Vad heter sjukdomen på den tiden?</label><textarea rows="1" cols="" id="q8"></textarea>
			</p>
			<div class="input-radio">
				<p>Finns det något läkemedel du dricker för närvarande?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<h2>KOL</h2>
			<p class="input-vertical adjustment-bottom-margin"><label>Hur många cigaretter röker du en dag? <br/> (Bok / dag)</label><input type="number" pattern="\d*" id="q11"></p>
			<div class="input-radio">
				<p>Stämmer du ofta fast efter att ha stigit på morgonen?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Har du ofta wheezes (Zezei, Hugh Hugh)?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Har du snarkat under de senaste 3 månaderna?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Har du fått veta av din familj att andningen kan sluta under sömnen under de senaste 3 månaderna?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Kände du dig sömnig och sovande eller somnade på dagtid eller under de senaste 3 månaderna?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<div class="input-radio">
				<p>Har du fått veta att blodsockernivån är hög?</p>
				<ul class="regulation-switch adjustment-bottom-margin flex-between">
			...
			<p class="btn-large" style="margin-top:48px"><a href="javascript:void(0)" onclick="alert('Vi korrigerade undersökningsinnehållet.');">korrigering</a></p>
		</form>
	</div>
</div>
<!-- SCRIPT -->
