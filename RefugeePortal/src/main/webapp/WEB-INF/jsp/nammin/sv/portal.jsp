...
<div id="wrapper">
    <div class="header-top">
 		...
 		<p><a href="javascript:confirmLogout()" onclick="">Logga ut</a></p>
 		</form>
    </div>
    <div id="top">
        <div class="news">
            <p>NEW</p>
            <p id="show-msg">Registreringen är klar</p>
        </div>
        ...
        <a href="javascript:alert('Vänligen få medicinska förfrågningar på Messenger. Om du redan har intervjuats vänligen ladda om.')" class="menu-btn">
        <% }else{ %>
