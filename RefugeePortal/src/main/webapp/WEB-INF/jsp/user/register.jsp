...
<title><%=msgBundle.getString("register.title")%></title>
	...
	<div class="document">
		...
		<div class="wrapper">
			...
			<div class="login-page__form">
				...
				<form class="form-horizontal" id="loginform" action="/user/register"
					method="post">
					<div class="login-item">
						<input type="text" class="form-control" name="username"
							id="username"
							placeholder='<%=msgBundle.getString("register.username")%>' />
					</div>
					<div class="login-item">
						<input type="password" name="password" id="password"
							autocomplete="off" class="form-control"
							placeholder='<%=msgBundle.getString("register.password")%>' />
					</div>
					<div class="login-item">
						<input type="password" name="confirm_password" id="confirm_password"
							autocomplete="off" class="form-control"
							placeholder='<%=msgBundle.getString("register.confirm_password")%>' />
					</div>
					<div class="login-item">
						<input type="text" class="form-control" name="email"
							id="email"
							placeholder='<%=msgBundle.getString("register.email")%>' />
					</div>
					<%
					...
					<div class="login-item login-item--buttons clearfix">
						<input type="submit"
							...
							value="<%=msgBundle.getString("register.title")%>" />
					</div>
				</form>
			</div>
		</div>
